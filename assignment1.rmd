...
lab1 <- paste("E1: ",substring(as.character(e1),1,6))
lab2 <- paste("E2: ",substring(as.character(e2),1,6))
...
ggplot()+
  ...
  geom_label(aes(x=(q2 - 30) , y=p2+30), label=lab2 ,nudge_x = -1, nudge_y=10, size=5)+
  geom_label(aes(x=q1 + 30  , y= p2 -30), label=lab1 ,nudge_x = 1, nudge_y=-10, size=5)+
  theme_bw()
